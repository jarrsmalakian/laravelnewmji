                    ...
                    <div class="container">
                        <div class="nav-scroller py-1 mb-2">
                            <nav class="nav d-flex justify-content-between">
                                <a class="p-2 link-secondary" href="#">Berita</a>|
                                <a class="p-2 link-secondary" href="#">Kegiatan</a>|
                                <a class="p-2 link-secondary" href="#">Kunjungan</a>|
                        ...
                        <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
                            <div class="col-md-6 px-0">
                                <h1 class="display-4 font-italic">Informasi Seputar Magang ke Jepang </h1>
                                <p class="lead my-3">LPK Mitra Jaya Indonesia merupakan lembaga pengirim (SO) dibawah
                                    naungan AP2LN. Mendapatkan izin resmi sebagai Lembaga Pelatihan Kerja Bahasa Jepang dari
                                    Dinas Tenaga Kerja dan Transmigrasi Kota Magelang pada tahun 2009. </p>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <div
                                    ...
                                    <div class="col p-4 d-flex flex-column position-static">
                                        ...
                                        <h3 class="mb-0">Pelaksanaan Tes Angkatan 89</h3>
                                        <div class="mb-1 text-muted">{{ date('d/M/y') }}</div>
                                        <p class="card-text mb-auto">LPK Mitra Jaya Indonesia kembali mengadakan tes
                                            perekrutan siswa magang baru angkatan 89</p>
                            ...
                            <div class="col-md-6">
                                <div
                                    class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                    <div class="col p-4 d-flex flex-column position-static">
                                        <strong class="d-inline-block mb-2 text-success">Kegiatan</strong>
                                        <h3 class="mb-0">Kunjungan Keluarga</h3>
                                        <div class="mb-1 text-muted">{{ date('d/M/y') }}</div>
                                        <p class="mb-auto">Direktur LPK Mitra Jaya Indonesia beserta staff melakukan
                                            kunjungan ke keluarga siswa magang di Kebumen</p>
                                        <a href="#" class="stretched-link">Continue reading</a>
                                    </div>
                                    <div class="col-auto d-none d-lg-block">
                                        <svg class="bd-placeholder-img" width="200" height="250"
                        ...
                        <div class="row">
                            ...
                            <aside class="col-md-4">
                                <div class="p-4 mb-3 bg-light rounded">
                                    ...
                                    <p class="mb-0">Etiam porta <em>sem malesuada magna</em> mollis euismod. Cras
                                        mattis consectetur
