                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('ap2ln')}}" clas="{{ (request()->segment('1') == 'home') ? 'active' : '' }}">AP2LN</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('berita/index')}}" clas="{{ (request()->segment('1') == 'home') ? 'active' : '' }}">berita</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('karir')}}" clas="{{ (request()->segment('1') == 'home') ? 'active' : '' }}">karir</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('kontak')}}" clas="{{ (request()->segment('1') == 'home') ? 'active' : '' }}">kontak</a>
                                </li>
